...
import {ValidationContainer, ValidationWrapperV1, ValidationInfo, ValidationBehaviour} from '../../../../../src';
...
export default class FormValidityDemo extends React.Component<{}, State> {
  ...
  private validate = (value: string, type: ValidationBehaviour): Nullable<ValidationInfo> => {
    return !/^\d*$/.test(value)
      ? {message: "Только цифры", type}
      : null;
  };
